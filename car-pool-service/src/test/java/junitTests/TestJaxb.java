...
import carPool.dto.Trip;
import jaxb.utility.DefaultSchemaOutputResolver;
import jaxb.utility.DefaultValidationEventHandler;
public class TestJaxb {
	...
	public void initializeFixtureObjects() {
		...
		_traveler = new Traveler(1, "t1@carpool.co.nz", "Traveler One",
				Gender.MALE, home, home);
		...
		_trip.setTravelerID(_traveler.getID());
	...
	/**
	 * Marshals a Traveler instance to XML, and directs the XML output to the
	 * console.
	 *
	 */
	@Test
	public void marshalTraveler() throws JAXBException {
	...
	/**
	 * Marshals a Trip instance to XML, and directs the XML output to the
	 * console.
	 *
	 */
	@Test
	public void marshalTrip() throws JAXBException {
	...
	/**
	 * Marshals a GeoPosition instance to XML, and directs the XML output to the
	 * console.
	 *
	 */
	@Test
	public void marshalGeoPosition() throws JAXBException {
		_marshaller.marshal(_geoPosition, System.out);
	}

	/**
	 * Marshals a GeoPosition instance, storing the generated XML in a ByteArray in
	 * memory. The XML representation is then unmarshalled to produce a copy of
	 * the original GeoPosition instance.
	 *
	 */
	@Test
	public void marshalAndUnmarshalGeoPosition() throws JAXBException {
		...
		// The two GeoPosition instances should have the same value (i.e. state).
